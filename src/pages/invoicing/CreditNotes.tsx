...
type CreditReason = "devolucion" | "descuento" | "error_precio" | "anulacion_parcial";
...
const CREDIT_NOTES: CreditNote[] = [
  { id: "1", serie: "FC01-00000018", refVoucher: "F001-00000892", clientName: "Constructora Alianza S.A.C.", clientDoc: "RUC 20556784912", date: "15 Oct, 2024", amount: "S/ 2,360.00", reason: "devolucion",        status: "accepted" },
  { id: "2", serie: "FC01-00000017", refVoucher: "F001-00000891", clientName: "Tech Solutions Peru S.A.C.", clientDoc: "RUC 20512345678",  date: "13 Oct, 2024", amount: "S/ 1,200.00", reason: "error_precio",      status: "accepted" },
  { id: "3", serie: "BC01-00000210", refVoucher: "B001-00001230", clientName: "María García López",          clientDoc: "DNI 45123789",     date: "10 Oct, 2024", amount: "S/   64.00", reason: "descuento",         status: "pending"  },
  { id: "4", serie: "FC01-00000016", refVoucher: "F001-00000889", clientName: "Distribuidora Norte E.I.R.L.",clientDoc: "RUC 20448123992",  date: "05 Oct, 2024", amount: "S/ 3,200.00", reason: "anulacion_parcial", status: "accepted" },
  { id: "5", serie: "FC01-00000015", refVoucher: "F001-00000882", clientName: "Clínica San Lucas S.A.",      clientDoc: "RUC 20456789012",  date: "01 Oct, 2024", amount: "S/   480.00", reason: "descuento",         status: "accepted" },
];
...
function buildColumns(): ColumnDef<CreditNote>[] {
  return [
    {
      key: "serie",
      header: "Serie / Número",
      ...
      render: (r) => (
        <>
          ...
          <CellSub>Nota de Crédito Electrónica</CellSub>
        </>
      ),
    },
    {
    ...
    { key: "date", header: "Fecha", width: "12rem" },
    {
      ...
      width: "14rem",
      align: "right",
      render: (r) => <MonoCell style={{ color: "var(--color-success)", fontWeight: 700 }}>-{r.amount}</MonoCell>,
    },
    {
      key: "reason",
      header: "Motivo",
    ...
    <ContentArea>
      <motion.div variants={fadeUp} initial="hidden" animate="visible">
        <Breadcrumb>
          ...
          <BreadcrumbActive>Notas de Crédito</BreadcrumbActive>
        </Breadcrumb>
        <PageHeading>
          <div>
            <PageTitle>Notas de Crédito</PageTitle>
            <PageSubtitle>Correcciones que reducen el monto de un comprobante ya emitido (devoluciones, descuentos, errores).</PageSubtitle>
          </div>
          <Button variant="primary" onClick={() => setDrawerOpen(true)}>
            <Icon name="add" size={18} />Nueva Nota de Crédito
          </Button>
        </PageHeading>
      </motion.div>
      ...
      <KpiGrid variants={staggerContainer} initial="hidden" animate="visible">
        <KpiCard variants={fadeUp}>
          <KpiLabel>Total Emitidas Mes</KpiLabel>
          <KpiValue>18</KpiValue>
          <KpiSub>+3 vs mes anterior</KpiSub>
          <KpiBgIcon><Icon name="remove_circle" size={80} /></KpiBgIcon>
        </KpiCard>
        <KpiCard variants={fadeUp}>
          <KpiLabel>Monto Acreditado</KpiLabel>
          <KpiValue $color="var(--color-success)">S/ 7,244</KpiValue>
          <KpiSub>Crédito a clientes</KpiSub>
        ...
        <KpiCard variants={fadeUp}>
          <KpiLabel>Por Devolución</KpiLabel>
          <KpiValue>06</KpiValue>
          <KpiSub>Motivo más frecuente</KpiSub>
          <KpiBgIcon><Icon name="undo" size={80} /></KpiBgIcon>
        </KpiCard>
      </KpiGrid>
      ...
      <motion.div variants={fadeUp} initial="hidden" animate="visible">
        <TablePanel>
          <TableHeader>
            <TableTitle>Registro de Notas de Crédito</TableTitle>
      ...
      {/* Nueva Nota de Crédito drawer */}
      <Drawer
        open={drawerOpen}
        onClose={() => setDrawerOpen(false)}
        title="Nueva Nota de Crédito"
        description="Modifica un comprobante ya emitido reduciendo su monto"
        size="lg"
        side="right"
      >
        <DrawerBody>
          <FormSection>
            ...
            <FieldGroup>
              ...
              <RefBox>
                ...
                <RefMono>F001-00000892</RefMono>
                <span style={{ fontSize: "1.2rem", color: "var(--color-text-muted)" }}>Constructora Alianza S.A.C.</span>
              </RefBox>
            </FieldGroup>
            <FieldGroup>
              ...
              <FieldSelect {...register("motivo")}>
                ...
                <option value="descuento2">04 — Descuento global</option>
                <option value="descuento3">05 — Descuento por ítem</option>
                <option value="devolucion2">06 — Devolución parcial</option>
          ...
          <FormSection>
            <SectionTitle>Productos / Ítems Afectados</SectionTitle>
          ...
          <FormSection>
            ...
            <FieldGroup>
              ...
              <FieldInput type="text" defaultValue="20556784912" readOnly />
            </FieldGroup>
            <FieldGroup>
              <FieldLabel>Razón Social</FieldLabel>
              <FieldInput type="text" defaultValue="Constructora Alianza S.A.C." readOnly />
            </FieldGroup>
          </FormSection>
        </DrawerBody>
            ...
            <DetailBody>
              <DetailSection>
                ...
                <DetailGrid>
                  ...
                  <DetailItem>
                    <ItemLabel>Monto Acreditado</ItemLabel>
                    <MonoValue style={{ color: "var(--color-success)" }}>-{detailNote.amount}</MonoValue>
                  </DetailItem>
                </DetailGrid>
              </DetailSection>
